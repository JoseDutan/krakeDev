let empleados = [
    ...
    { cedula: "0302578166", nombre: "Jose", apellido: "Dutan", sueldo: 600.0 }
]
                ...
                if (valorSueldo >= 400 && valorSueldo <= 5000) {
                    ...
                    if (esNuevo == true) {
                        ...
                        if (guardarEmpleado == true) {
                            ...
                            let empleadoEncontrado=buscarEmpleado(objetoEmpleado.cedula);
                        }
                    } else {
...
ejecutarBusqueda = function () {
    ...
    if (empleado === null) {
        ...
        mostrarTextoEnCaja("txtEdad", empleado.sueldo);
        deshabilitarComponente("txtCedula");
        habilitarComponente("txtNombre");
        habilitarComponente("txtApellido");
        habilitarComponente("txtSueldo");
